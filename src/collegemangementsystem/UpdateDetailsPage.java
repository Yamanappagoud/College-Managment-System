...
public class UpdateDetailsPage extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                System.out.println("Search id details: " + rs.getString("ID"));
                DataBundle dataBundle = new DataBundle();
                dataBundle.put("id", Tf1);
                
                UpdateStudentsDetails updateStudentsDetails = new UpdateStudentsDetails(dataBundle);
                updateStudentsDetails.setVisible(true);
                dispose();
                        
            } else {
                System.out.println("No such ID found.");
                JOptionPane.showMessageDialog(rootPane, "No such ID found. Enter the correct ID.");
            }
